...
#ifndef STUDYCANVAS_SWIFT_H
#define STUDYCANVAS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StudyCanvas",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC11StudyCanvas11DrawingView")
...
SWIFT_CLASS("_TtC11StudyCanvas19OptimizedScrollView")
@interface OptimizedScrollView : NSScrollView
...
@class WKWebView;
@class WKNavigation;
SWIFT_CLASS("_TtC11StudyCanvas25WebViewNavigationDelegate")
